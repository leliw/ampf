...
class ApiTestClient(TestClient):
    def get(self, url: httpx._types.URLTypes | Path, status_code: Optional[int] = None, **kwargs) -> httpx.Response:
    ...
    def post(self, url: httpx._types.URLTypes | Path, status_code: Optional[int] = None, **kwargs) -> httpx.Response:
        if isinstance(url, Path):
            url = str(url)
    ...
    def put(self, url: httpx._types.URLTypes | Path, status_code: Optional[int] = None, **kwargs) -> httpx.Response:
        if isinstance(url, Path):
            url = str(url)
        self._prepare_parameters(kwargs)
    ...
    def patch(self, url: httpx._types.URLTypes | Path, status_code: Optional[int] = None, **kwargs) -> httpx.Response:
        if isinstance(url, Path):
            url = str(url)
        self._prepare_parameters(kwargs)
    ...
    def delete(self, url: httpx._types.URLTypes | Path, status_code: Optional[int] = None, **kwargs) -> httpx.Response:
        if isinstance(url, Path):
            url = str(url)
